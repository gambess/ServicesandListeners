...
//$client = new RpcClient($host, $login, $password);
//$respuesta = $client->__call("MensajeriaNegocios_enviarSMS",array($login, $password, array(array('602814043', 'Texto de Prueba 1', 'Raziel'))));
//print_r($respuesta);
